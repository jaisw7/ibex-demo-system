 ...
 */
void usb_testutils_streams_init(usb_testutils_streams_ctx_t *ctx,
 ...
 * @param  ctx       Context state for streaming test
 */
void usb_testutils_streams_service(usb_testutils_streams_ctx_t *ctx);
 ...
 */
void usb_testutils_stream_init(usb_testutils_streams_ctx_t *ctx, uint8_t id,
                               uint8_t ep_in, uint8_t ep_out,
                               uint32_t num_bytes, usbdev_stream_flags_t flags,
                               bool verbose);
 ...
 * @param  id        Stream identifier (0-based)
 */
void usb_testutils_stream_service(usb_testutils_streams_ctx_t *ctx, uint8_t id);
