...
//      kTopEarlgreyPinmuxInselIoc7));
  ...
  usb_testutils_streams_init(ctx, nstreams, transfer_bytes, test_flags,
                             verbose);
  ...
  bool done = false;
  do {
    usb_testutils_streams_service(ctx);
...
extern inline uint64_t ibex_mcycle_read(void);
